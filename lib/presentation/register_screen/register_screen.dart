            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText: AppString.hintTextRegister1,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    filled: true,
                    fillColor: theme.inputDecorationTheme.fillColor,
                    hintText: AppString.hintTextRegister2,
                    hintStyle: TextStyle(color: AppColor.hintTextColor),
                    border: OutlineInputBorder(
                      borderSide: BorderSide.none,
                      borderRadius: BorderRadius.circular(4),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    filled: true,
                    fillColor: theme.inputDecorationTheme.fillColor,
                    hintText: AppString.hintTextRegister3,
                    hintStyle: TextStyle(color: AppColor.hintTextColor),
                    border: OutlineInputBorder(
                      borderSide: BorderSide.none,
                      borderRadius: BorderRadius.circular(4),
              ...
              CmButton(
                  ...
                  title: Row(
                    ...
                    children: [
                      ...
                      const Text(AppString.registerWithFb,
                          style: TextStyle(
                  ...
                  title: Row(
                    ...
                    children: [
                      SvgPicture.asset(AppAssets.icGoogle,
                          width: 30, height: 30, fit: BoxFit.fill),
                      const SizedBox(width: 10),
                      const Text(AppString.registerWithGg,
                          style: TextStyle(
                              fontSize: 16, fontWeight: FontWeight.bold))
                    ],
                  ),
